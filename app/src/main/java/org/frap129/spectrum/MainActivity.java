...
import static org.frap129.spectrum.Utils.getenProp;
...
public class MainActivity extends AppCompatActivity {
    ...
    private List<String> suResult4 = null;
    ...
    private void getDesc() {
        ...
        suResult4 = Shell.SU.run(String.format("getenforce"));
        ...
        String kernel4 = listToString(suResult4);
        if (kernel4.isEmpty())
            return;
        String geten = desc8.getText().toString();
        geten = geten.replaceAll("\\bgeten\\b", kernel4);
        desc8.setText(geten);
